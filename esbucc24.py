...
film1 = Film("mish merda", "nick pineapple", 2010, "Buccino", 9)
film2 = Film("la casa infestata", "alessandro cervesi", 2008, "horror", 10)
film3 = Film("amin zeb e il suo cromosoma in meno", "Quentin Tarantino", 1994, "storia vera", 8)
film4 = Film("Torsani ferito", "William Friedkin", 1973, "divertente", 7)
